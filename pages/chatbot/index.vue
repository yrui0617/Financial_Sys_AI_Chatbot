...
<template>
  ...
  <div :class="[
    'h-screen transition-colors duration-300 bg-gray-50 text-gray-800 dark:bg-gray-950 dark:text-gray-200'
  ]"
  ...
  >
    <div class="flex h-screen">
      ...
      <div v-if="showDeleteModal" class="fixed inset-0 flex items-center justify-center bg-black/50 z-50">
        <div
          class="w-96 rounded-xl p-5 shadow-lg border"
      ...
      <aside
        ...
        class="flex flex-col w-80 p-3 gap-3 border-r bg-white border-gray-200 dark:bg-gray-900 dark:border-gray-800"
      >

        <button @click="goBack" class="p-2 rounded-md hover:bg-gray-100 dark:hover:bg-gray-800 dark:bg-gray-900 dark:border-gray-700">
          ⬅ Back
        </button>
        ...
        <div
          ...
          :key="c.id"
          class="relative group flex items-center justify-between p-3 rounded cursor-pointer transition"
          :class="[
        ...
        >
          ...
          <div class="flex-1" @click="selectConversation(c.id)">
            ...
            <input
              ...
              class="w-full px-2 py-1 rounded border bg-white text-black dark:bg-gray-800 dark:border-gray-600 dark:text-white"
            />
          </div>
          ...
          <div class="relative">
            <button
              ...
              class="opacity-0 group-hover:opacity-100 transition p-1"
            >
            ...
            <div
              ...
              @click.stop
              class="absolute right-0 mt-2 w-36 rounded-lg shadow border z-40 bg-white border-gray-200 dark:bg-gray-900 dark:border-gray-700"
            >

              <!-- RENAME -->
              <div
                @click="renameTitle(c)"
                class="flex items-center gap-2 px-3 py-2 hover:bg-gray-100 dark:hover:bg-gray-800 cursor-pointer"
              >
                <svg class="w-6 h-6 text-gray-800 dark:text-white" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24">
        ...
        <button @click="toggleColorMode"
          class="p-2 border rounded-md flex items-center justify-center">
      ...
      <main class="flex-1 flex flex-col">
        ...
        <div
          class="p-3 border-b text-center font-bold border-gray-200 bg-white dark:border-gray-800 dark:bg-gray-900 relative"
        >
          <button
            @click="isSidebarOpen = !isSidebarOpen"
            class="md:hidden absolute left-3 top-1/2 transform -translate-y-1/2 p-2 hover:bg-gray-100 dark:hover:bg-gray-800 dark:bg-gray-900 dark:border-gray-700"
          >
          ...
          <div class="max-w-3xl mx-auto space-y-4">
            ...
            <div v-for="m in messages" :key="m.id">  
              ...
              <div v-if="m.role === 'user'" class="flex justify-end">
                <div class="bg-blue-500 text-white px-4 py-2 rounded-lg shadow whitespace-pre-line max-w-xs md:max-w-md lg:max-w-lg break-words text-left">
                  {{ m.content }}
                </div>
              </div>
              ...
              <div v-else class="text-left">
                <div
                  class="px-4 py-2 rounded-lg inline-block shadow whitespace-pre-line bg-gray-200 text-gray-800 dark:bg-gray-800 dark:text-gray-200"
                >
                  {{ m.content }}
                </div>
              </div>
            ...
            <div v-if="isThinking" class="flex justify-start">
              <div class="bg-gray-200 dark:bg-gray-800 px-4 py-2 rounded-lg inline-flex items-center gap-2 shadow max-w-xs">
                <svg class="w-5 h-5 animate-spin text-gray-600 dark:text-gray-300" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24">
        ...
        <div class="p-3">
          <div class="max-w-3xl mx-auto flex gap-2">
            <textarea
              ...
              rows="1"
              class="flex-1 p-3 rounded-lg resize-none bg-white border border-gray-300 text-black dark:bg-gray-800 dark:border-gray-700 dark:text-white"
              placeholder="Type message..."
            />
             <!-- MICROPHONE BUTTON -->
            <div class="relative">
              <button @click="toggleMic" class="group relative z-10 flex h-10 w-10 items-center justify-center rounded-full bg-white shadow-md transition-transform hover:scale-105 focus:outline-none focus:ring-2 focus:ring-blue-400 active:scale-95" aria-label="Start voice recording">
                  <svg v-if="!isRecording"
                  xmlns="http://www.w3.org/2000/svg" 
                  class="h-4 w-4 text-slate-600 transition-colors group-hover:text-blue-500" 
            ...
            <button 
              ...
              class="bg-primary text-white px-4 rounded-xl disabled:opacity-50 disabled:cursor-not-allowed z-50"
            >
