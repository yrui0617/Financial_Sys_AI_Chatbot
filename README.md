...
Staff:{ username: staff, password: abc123}
User:{ username: user, password: abc123}

## 🎯 Overview

Financial System AI Chatbot is a full-featured financial application designed to streamline financial workflows and provide intelligent assistance through an integrated chatbot. The system helps users and staff manage financial operations including bill tracking, voucher management, and payment processing.
